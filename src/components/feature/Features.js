...
const Features = () => {
  return (
    <div className="flex flex-col items-center justify-between p-6 bg-gradient-to-tl from-blue-200 via-blue-100 md:px-14 md:py-10 mmmd:px-32 lg:px-20 llg:px-32 xl:px-48 xxl:px-72 4xl:px-88 5xl:px-96 6xl:px-104">
